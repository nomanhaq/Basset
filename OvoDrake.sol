/**
 * This code deployed by nomanhaq@hotmail.com for olaris Token

Hello Brother,

How are you doing, today I have completed your smart contract code and deploy your contract on testnet, please find below testnet results:

https://testnet.bscscan.com/tx/0xc930d20fadcfb3af1f921e38f685a9c8514287ab6278e287b4a605c8ac54f398

https://testnet.bscscan.com/address/0x973301b5757eeef8e6d20667fccfa4d7100c71e3

https://testnet.bscscan.com/token/0x973301b5757eeef8e6d20667fccfa4d7100c71e3

Please suggest if we together deploy your contract on mainnet tomorrow at 4 pm Bahrain time. It can be plus minus in timings
...
abstract contract Ownable is Context {
    ...
    constructor () {
     ...
     //   _owner = 0x54474f84CE5fbA040CF8866E74945e1d75Cea35E; // OVO Owner Address for test         
...
contract OVO is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x8E29950307C59591dD40742a3871A949Aa4111Ea; // Charity address
   // address private _charityWalletAddress = 0xE834a9C50e779F989915Cb14A198D11749247435; // OVO Charity Address
    ...
    uint256 private numTokensSellToAddToLiquidity = 1800000 *  10**9;
    ...
    constructor () {
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);// BSC mainnet V1 Router
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);// BSC testnet        
        
         IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);// BSC mainnet V2 Router
