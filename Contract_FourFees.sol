/**
0xFd415CE0e2C38bBE16C1c0307b62e93f8c112a61
    https://bscscan.com/address/0x8D45F2AC032eC33D5db5030d433E8426B595FD64#code
    ...
    uint256 public _burnFee = 0; // means 0% it menas on burn 
    
    uint256 public charityFee=100; //100 means 1% will send to charity
    
    
    address charityAddress=0x757256e385c3a54C501C66519304ee1c236dEdf4; //
...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x5c2548cD334d3572c1aB24EAA0d8166Ff0112B4f;
...
contract SAFEBE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "SAFEBE";
    string private _symbol = "SAFEBEE";
